...
namespace YL.Web.Api.ThirdParty.Loan.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoanWriteOffDetailsModel :  IEquatable<LoanWriteOffDetailsModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanWriteOffDetailsModel" /> class.
        /// </summary>
        /// <param name="paymentDate">Gets or sets the Payment Date.</param>
        /// <param name="paymentAmount">Gets or sets the Payment Amount.</param>
        public LoanWriteOffDetailsModel(DateTime paymentDate = default(DateTime), double paymentAmount = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoanWriteOffDetailsModel {\n");
        ...
        {
            return this.Equals(input as LoanWriteOffDetailsModel);
        }

        /// <summary>
        /// Returns true if LoanWriteOffDetailsModel instances are equal
        /// </summary>
        /// <param name="input">Instance of LoanWriteOffDetailsModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanWriteOffDetailsModel input)
        {
            if (input == null)
                return false;
